...
public class GenUtils {
    ...
    public static List<String> getTemplates() {
        ...
        templates.add("template/SearchDto.java.vm");
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        for (Map<String, String> column : columns) {
            ...
            // 生成set,get方法
            columnEntity.setSetAttrName("set" + attrName + "(");
            columnEntity.setGetAttrName("get" + attrName + "()");
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains("Entity.java.vm") || template.contains("MongoEntity.java.vm")) {
            return packagePath + "entity" + File.separator + className.toLowerCase() + File.separator + className + "Entity.java";
        }
        ...
        if (template.contains("ServiceImpl.java.vm")) {
            return packagePath + "service" + File.separator + className.toLowerCase() + File.separator + "impl" + File.separator + className + "ServiceImpl.java";
        }
        ...
        if (template.contains("SearchDto.java.vm")) {
            return packagePath + "dto" + File.separator + className.toLowerCase() + File.separator+ "Search" + className + "Dto.java";
        }

        if (template.contains("AddDto.java.vm")) {
            return packagePath + "dto" + File.separator + className.toLowerCase() + File.separator + "Add" + className + "Dto.java";
        }

        if (template.contains("UpdateDto.java.vm")) {
            return packagePath + "dto" + File.separator + className.toLowerCase() + File.separator+ "Update" + className + "Dto.java";
        }

        if (template.contains("Vo.java.vm")) {
            return packagePath + "vo" + File.separator + className.toLowerCase() + File.separator + className + "Vo.java";
        }

        if (template.contains("Dao.xml.vm")) {
            return "main" + File.separator + "resources" + File.separator + "mybatis" + File.separator + "mapper" + File.separator + className.toLowerCase() + File.separator + className + "Dao.xml";
        }

        if (template.contains("Mapper.xml.vm")) {
            return "main" + File.separator + "resources" + File.separator + "mybatis" + File.separator + "mapper" + File.separator + className.toLowerCase() + File.separator + className + "Mapper.xml";
        }
